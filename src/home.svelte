...
<div class="w-full h-full bg-sky-300 py-1" >
    <div class="w-full flex justify-center">
        <button class={`${isShowInput ? "hidden" : ""} text-sm font-serif text-center py-4 text-pink-400`} on:click={()=>isShowInput=true} >{userName??"please input user name"}</button>
        <div class={`${isShowInput ? "" : "hidden"} text-sm font-serif text-center w-36 py-2 text-pink-400 flex items-center`}>
            <!-- svelte-ignore a11y-autofocus -->
            <input autofocus type="text" bind:value={userName} placeholder="user name" class="h-8 w-24 px-2 outline-0 rounded-sm"/>
            <button class="h-8 shadow-sm rounded-sm mx-2 text-sm px-1 hover:bg-sky-700" on:click={saveAction}>
                <svg class="h-8 w-8 fill-pink-400" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="2558" width="200" height="200"><path d="M1006.8 230.9l-96.4-96-573.9 573.8-235.2-235.2-96.5 96.1 329.5 333.9 2.2-2.2 97.7-94.9-1.4-1.4z" p-id="2559"></path></svg>
            </button>
        </div>
    </div>
